...
const gameFlow = (() => {
  ...
  const checkResult = () => {
    ...
    console.log("im here");
    if (
      document.getElementById("0").textContent === player1.getMark() &&
    ...
    //p2 hor lines/
      ...
      document.getElementById("0").textContent === player2.getMark() &&
    ...
    //p2 diagon lines
      ...
      document.getElementById("0").textContent.length !== 0 &&
